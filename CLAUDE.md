# Wu Boshi Perspective For Claude Code
...
- a visible solve order
- a skill activation ladder
- a decomposition checklist
- a route narration script
...
Allow only a thin non-workflow bias toward:
...
- reduced authority of ordinary thick routes
...
If stronger effect requires more explicit packaging, the host is moving in the wrong direction.
